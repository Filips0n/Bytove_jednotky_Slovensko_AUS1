...
namespace structures
{
	...
	public:
		...
		virtual void setScenario(int scenario);

		virtual char getTypeOfShortList();
	protected:
		/// <summary> Konstruktor. </summary>
		PriorityQueue();
	...
	template<typename T>
	inline void PriorityQueue<T>::setScenario(int scenario)
	{
	}

	template<typename T>
	inline char PriorityQueue<T>::getTypeOfShortList()
	{
		return 0;
	}
